...
import { Dimensions, KeyboardAvoidingView, Linking, Platform, SafeAreaView, View, Image, Text, ScrollView, TouchableOpacity } from 'react-native';
...
export default ErrorWebView = (props) => {
    ...
    return <ScrollView style={{ height: SCREEN_HEIGHT, position: 'absolute', top: 0, left: 0, width: SCREEN_WIDTH,  backgroundColor: "white" }}>
