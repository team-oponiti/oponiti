...
- (NSDictionary *)constantsToExport
{
  ...
  return @{
    @"env": @"prod",
    @"chat": @"http://43.203.234.150/chat/",
    @"membership": @"http://43.203.234.150/detective-membership/",
    @"account": @"http://43.203.234.150/detective-account/",
    @"more": @"http://43.203.234.150/detective-more/",
    @"blog": @"http://43.203.234.150/blog/",
    @"domain": @"43.203.234.150",
    @"login": @"http://43.203.234.150/detective-login/",
